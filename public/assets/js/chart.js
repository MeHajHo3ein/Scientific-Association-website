...
!(function (t, e) {
  ...
  function f(t, e) {
    ...
    for (i = 0, s = t.length; i < s; ++i)
      if (
        ((n = t[i]), (o = e[i]), n.datasetIndex !== o.datasetIndex || n.index !== o.index)
      )
        return !1;
    return !0;
  }
  ...
  function pt(t, e, i) {
    ...
    if (t._sorted) {
      ...
      if (g) {
        if (
          ((o = Math.min(it(h, d, u).lo, i ? n : it(e, d, r.getPixelForValue(u)).lo)), c)
        ) {
          const t = h
            .slice(0, o + 1)
            .reverse()
      ...
      (function (t, e, i = "x") {
        ...
        for (let h = 0; h < n; ++h) {
          ...
          const n = r[i],
            c = r[s];
          (a &&
            ((o = (n - a[i]) / 3), (r[`cp1${i}`] = n - o), (r[`cp1${s}`] = c - o * e[h])),
            l &&
              ((o = (l[i] - n) / 3),
              (r[`cp2${i}`] = n + o),
              (r[`cp2${s}`] = c + o * e[h])));
  ...
  class $n extends js {
    ...
    updateElements(t, e, i, s) {
      ...
      for (p = e; p < e + i; ++p) {
        ...
        (g &&
          (o.options = f || this.resolveDataElementOptions(p, i.active ? "active" : s)),
          (m += e),
      ...
      updateElements(t, e, i, n) {
        ...
        for (let f = e; f < e + i; f++) {
          const e = this.getParsed(f),
            i =
              o || s(e[r.axis]) ? { base: l, head: l } : this._calculateBarValuePixels(f),
      ...
      _calculateBarIndexPixels(t, e) {
        ...
        if (e.grouped) {
          const i = o ? this._getStackCount(t) : e.stackCount,
            ...
            g =
              this._getStackIndex(this.index, this._cachedMeta.stack, o ? t : void 0) + f;
  ...
  var go = Object.freeze({
    ...
    PointElement: class extends $s {
      ...
      inRange(t, e, i) {
        ...
        return (
          Math.pow(t - n, 2) + Math.pow(e - o, 2) < Math.pow(s.hitRadius + s.radius, 2)
        );
      }
      inXRange(t, e) {
  ...
  class bo extends tn {
    ...
    parse(t, e) {
      return s(t) || (("number" == typeof t || t instanceof Number) && !isFinite(+t))
        ? null
        : +t;
    }
