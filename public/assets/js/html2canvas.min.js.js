...
!(function (A, e) {
    ...
    Tt = {
      ...
      parse: function (n, A) {
        return 1 === A.length && jA(A[0], "none")
          ...
          : Ae(A).map(function (A) {
              for (
                var e = { color: Le.TRANSPARENT, offsetX: ae, offsetY: ae, blur: ae },
                  t = 0,
                  r = 0;
                r < A.length;
                r++
                ...
                var B = A[r];
                ee(B)
                  ? (0 === t ? (e.offsetX = B) : 1 === t ? (e.offsetY = B) : (e.blur = B),
                    t++)
                  : (e.color = ue(n, B));
              }
              return e;
  ...
  var br,
    ...
    Xr = {
      ...
      get SUPPORT_FOREIGNOBJECT_DRAWING() {
        var A =
          "function" == typeof Array.from && "function" == typeof window.fetch
            ...
            : Promise.resolve(!1);
        return (
          Object.defineProperty(Xr, "SUPPORT_FOREIGNOBJECT_DRAWING", { value: A }),
          A
        );
      },
      ...
      get SUPPORT_NATIVE_TEXT_SEGMENTATION() {
        ...
        return (
          Object.defineProperty(Xr, "SUPPORT_NATIVE_TEXT_SEGMENTATION", { value: A }),
          A
        );
      },
    },
                  ...
                  ? ((e = Zr(A)),
                    ...
                    e.forEach(function (A) {
                      (o.push(
                        new Jr(
                          A,
                          d.fromDOMRectList(B, Wr(s, t + i, A.length).getClientRects()),
                        ),
                      ),
                        (t += A.length));
                    }))
  ...
  function EB(A, e) {
    ...
    switch (
      ...
      (t.value =
        0 ===
        (e = (A = e).type === fB ? new Array(A.value.length + 1).join("•") : A.value)
          .length
          ? A.placeholder || ""
          : e),
      (t.type !== hB && t.type !== dB) ||
    ...
    try {
      e.contentWindow &&
        ...
        (t = e.contentWindow.document.documentElement
          ? fe(
              A,
              getComputedStyle(e.contentWindow.document.documentElement).backgroundColor,
            )
          : Le.TRANSPARENT),
  ...
  var gn,
    ...
    Un = {
      integers: [
        9e3, 8e3, 7e3, 6e3, 5e3, 4e3, 3e3, 2e3, 1e3, 900, 800, 700, 600, 500, 400, 300,
    ...
    ln = {
      integers: [
        1e4, 9e3, 8e3, 7e3, 6e3, 5e3, 4e3, 3e3, 2e3, 1e3, 400, 300, 200, 100, 90, 80, 70,
    ...
    Cn = {
      integers: [
        1e4, 9e3, 8e3, 7e3, 6e3, 5e3, 4e3, 3e3, 2e3, 1e3, 900, 800, 700, 600, 500, 400,
        ...
        return H(this, function (A) {
          switch (A.label) {
            case 0:
              ...
              (r =
                !Xn(s) && !0 === this._options.useCORS && Xr.SUPPORT_CORS_IMAGES && !e),
              (t =
                !Xn(s) &&
                !e &&
                !Yn(s) &&
      ...
      Q.container.elements.forEach(function (A) {
        ...
        (e || t
          ? ((B = e || A.styles.isPositioned() ? a : c),
            ...
            hs(r, t, e ? t : a, i))
          : ((A.styles.isInlineLevel() ? c.inlineLevel : c.nonInlineLevel).push(r),
            hs(r, c, a, i)),
          Pt(A.flags, 8) && ds(A, i));
      });
    },
    ...
    ps = function (A, e, t) {
      ...
      if (
        ...
        null !==
          (c =
            null !==
              (a = null !== c && (!o || us(o)) ? (Q && e ? (c / r) * B : t.height) : a) &&
            us(s)
              ? Q && e
                ? (a / B) * r
                : t.width
                ...
                return s < o.length
                  ? 0 !== (i = o[s]).style && !oe(i.color) && 0 < i.width
                    ? 2 !== i.style
                      ...
                      : [
                          4,
                          this.renderDashedDottedBorder(i.color, i.width, n, c.curves, 2),
                        ]
                    : [3, 11]
                  : [3, 13];
              case 4:
          ...
          switch (A.label) {
            case 0:
              ...
              return (
                ...
                (c = {
                  windowWidth:
                    null !== (c = F.windowWidth) && void 0 !== c ? c : t.innerWidth,
                  windowHeight:
                    null !== (a = F.windowHeight) && void 0 !== a ? a : t.innerHeight,
            ...
            case 1:
              ...
              (l = {
                ...
                scale:
                  null !==
                    (l =
                      null !== (l = F.scale) && void 0 !== l ? l : t.devicePixelRatio) &&
                  void 0 !== l
                    ? l
                    : 1,
