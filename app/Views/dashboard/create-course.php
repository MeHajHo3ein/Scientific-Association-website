      ...
      <div
        ...
        <div class="offcanvas-body p-3">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <button class=" text-start btn my-1 btn-outline-light py-2 w-100 ">فایل های آموزش آفلاین
              </button>
            </li>
            <li class="nav-item">
              <button class=" text-start btn my-1 btn-outline-light py-2 borde w-100 ">اعلانات
              </button>
            </li>
            <li class="nav-item">
