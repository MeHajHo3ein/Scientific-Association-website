...
<div class="col-md-10 offset-md-2 p-4">
  <div class="container">
    ...
    <!--                    </tr>-->
    <!--                </table>-->
    <!--                <a class="text-decoration-none btn btn-primary text-center my-1 w-100" href="./course-create.html">افزودن</a>-->
    <!--            </div>-->

    <!-- ***** Articles ***** -->
    <!--            <div class="row table-responsive overflow-visible">-->
    <!--                <h3 class="text-primary">مقالات</h3>-->
    <!--                <table class="table table-bordered table-hover table-striped">-->
    <!--                    <tr>-->
    <!--                        <th>عنوان</th>-->
    <!--                        <th>نویسنده</th>-->
    ...
    <!--                        onclick="openModal('addarticles')">-->
    <!--                    افزودن-->
    <!--                </button>-->
    <!--            </div>-->
    <!--            <div id="addarticles" class="modal">-->
    ...
    <!-- ***** Announcements-View ***** -->
    <!--            <div class="bg-white p-4 border-3 border-primary border-bottom my-4">-->
    ...
    <!--                </p>-->
    <!--            </div>-->
    <!--            &lt;!&ndash;            Add/Announcements&ndash;&gt;-->
    <!--            <button-->
    <!--                    class="btn btn-primary my-1 w-100"-->
    <!--                    onclick="openModal('addnotif')">-->
    <!--                افزودن-->
    <!--            </button>-->
